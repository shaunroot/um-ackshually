...
extension** in the bot account's own logged-in session on old.reddit.com (or www.reddit.com
with the old layout enabled in Reddit preferences). Open or refresh
...
extension/
  ...
  content.js        runs on inbox and comment pages: scrape -> ask WordPress -> post -> mark read
